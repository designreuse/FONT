...
<script type="text/javascript" charset="utf-8">
	...
	function retrieveData(sSource, aoData, fnCallback) {
		$.ajax({
			...
			data : {
				...
				"recommendtype" : $("#searRecommendtype").val()
			},
			type : 'post',
			dataType : 'json',
			//async : false,
				...
				.DataTable(
						{
							...
							"order" : [ [ 2, "asc" ] ],
							"paging" : true,
							"sAjaxSource" : "${spath}/recommend/query", // 通过ajax实现分页的url路径
	...
	function initFontTable() {
		fontTable = $('#fontTable').DataTable({
			...
			//"order" : [ [ 4, "desc" ] ],
			"paging" : true,
			"sAjaxSource" : "${spath}/recommend/queryFont", // 通过ajax实现分页的url路径
...
/*  			"aoColumnDefs" : [ {
	...
	function resetForm() {
		...
		$("#form span").html("");
		// 清楚下拉框
		//$("#apptype option").removeAttr("selected");
	}
	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			...
			<ol class="breadcrumb">
				<li><a>主页</a></li>
				<li><a>字体管理</a></li>
				<li class="active"><strong>精彩推荐</strong></li>
			</ol>
		</div>
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0"
							...
							<tbody>
								<tr>
									...
									<td align="right">推荐类型：<label class="inline"> <select
											class="form-control m-b" name="channelid" id="searRecommendtype">
											<option value="">全部</option>
											<option value="0">行推荐</option>
											<option value="1">列推荐</option></select>
									</label> &nbsp;&nbsp;字体名称：<label class="inline"> <input
											type="text" class="inputtext" id="fontname" name="fontname"
		...
		<div class="modal-dialog">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					...
					<h4 class="modal-title">添加推荐字体</h4>
				</div>
				<div class="modal-body">
					<form id="form" enctype="multipart/form-data"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label class="radio-inline"> <input value="0"
									name="recommendtype" type="radio"> 行推荐
								</label> <label class="radio-inline"> <input value="1"
									name="recommendtype" type="radio"> 列推荐
								</label>
								<span class="help-block m-b-none"
									style="color: red;" id="recommendtypeErr"></span>
							</div>
						</div>
