...
$.extend(true,snakerflow.config.tools.states,{
			...
			task : {
				...
				props : {
					...
					assigneeDisplay: {name:'assigneeDisplay', label: '参与者', value:'', editor: function(){return new snakerflow.editors.assigneeEditor('/actorController/dialogs/selectDialog?type=orgUserTree');}},
